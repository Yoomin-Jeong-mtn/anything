...
BRAZE_API_KEY = "9d075fc3-cd26-4980-bddf-254eec5a13a5"
...
# 포맷/버튼 가공
# ==============================
def extract_format_from_variant_name(variant_name: str):
    if not variant_name:
        return None
...
if __name__ == "__main__":
    ...
    df = df[
        ["id", "CAMPAIGN_API_ID", "CAMPAIGN_NAME", "CAMPAIGN_VARIANT_NAME", "FORMAT", "VALID_BUTTON_ID"]
    ].sort_values(
